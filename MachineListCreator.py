...
def MachineList():
    ...
    machineFirstSuffix = input("Enter the first suffix ID of the machine range (ex. 1, 5, etc)")
    machineFirstSuffix = int(machineFirstSuffix)
    
    machineLastSuffix = input("Enter the last suffix ID of the machine range (ex. 80, 90, etc)")
